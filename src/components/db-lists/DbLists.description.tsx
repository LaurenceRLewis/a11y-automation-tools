...
export const ListDescription = (
  <div className="docs--wrapper">
    ...
    <p>
      This component helps test HTML list structures and their impact on
      accessibility. You can toggle between valid and invalid scenarios to
      evaluate how automated tools respond to broken or malformed list markup.
    </p>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Selects the test case to apply, including valid list rendering and
            deliberately broken structures.
          </td>
        </tr>
        <tr>
          <td><code>listType</code></td>
          <td>
            Defines whether the base list should be a <code>&lt;ul&gt;</code> or{" "}
            <code>&lt;ol&gt;</code>.
          </td>
        </tr>
      </tbody>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Projects <code>&lt;li&gt;</code> elements via <code>children</code></td>
        </tr>
        <tr>
